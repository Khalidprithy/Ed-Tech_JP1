    ...
    return (
        <div className='px-10 bg-base-300'>
            <div className='text-left'>
                <h1 className='text-2xl font-bold pt-2'>Pick your desired course</h1>
            ...
            <div class="grid grid-cols-3 grid-flow-row gap-4 mt-4">
                <div class="card card-compact w-60 bg-base-100 rounded-md shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button class="btn btn-sm btn-link">Buy Now</button>
                        </div>
                    </div>
                </div>
                <div class="card card-compact w-60 bg-base-100 rounded-md shadow-lg">
